...
<div class="row">
    ...
    <div class="col">
        ...
        <div class="col">
            <ul>
                <li>Flawless and professional grading.</li>
                <li>Adhering to the highest measure of objectivity during grading. </li>
                <li>Strict compliance with prevailing standards set by international diamond organizations during every grading process.</li>
                <li>Employment of professionals that are skilled and well-trained to use sophisticated grading equipment, and also comply with prevailing standards.</li>
                <li>Provision of certificates for appraised gemstones and jewelry items.</li>
            </ul>
        </div>
        <div class="col">
            <ul>
                <li>Ensuring that our business locations do not jeopardize the convenience of our clients.</li>
                <li>Utilizing our vast experience to provide consultation services on polished diamond improvements, alongside the planning and marking of rough diamonds.</li>
                <li>Training and keeping our professionals abreast of the latest developments in the industry.</li>
                <li>Guidance for consumers who need help in deciding the diamond type to purchase.</li>
                <li>Running promotional ads on prominent platforms such as trade magazines and digital ads. We also reach into the spotlight of global diamond functions such as tradeshows and exhibits.</li>
            </ul>
        </div>
        </div>
...
<div class="row" style="background-image: url('{{asset('assets/images/banner-verification.png')}}'); background-size: 100%; background-repeat:  no-repeat;">
      <div class="col-md" style="padding: 11% 0; background: #fff;">
